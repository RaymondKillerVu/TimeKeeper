...
#		    	print IDCardNumber
			...
			_dataWriteMainApp["data"]["mess"] = "score: " + str("%.2f" % (__respont["data"]["result"][0]["score"]*100)) + "% => Moi Ban Vao!"
			...
			_dataWriteMainApp["data"]["company"] = userData["username"]
		    	_dataWriteMainApp["data"]["ID"] = IDCardNumber
                    	...
                    	_dataWriteMainApp["data"]["mess"] = "score: " + str("%.2f" % (__respont["data"]["result"][0]["score"]*100)) + "% => Ban Cam Nham The Roi!"
                    	_dataWriteMainApp["data"]["name"] = ""
                    	_dataWriteMainApp["data"]["company"] = ""
		    	_dataWriteMainApp["data"]["ID"] = IDCardNumber
			...
			_dataWriteMainApp["data"]["mess"] = "server dang co loi!"
                    	_dataWriteMainApp["data"]["name"] = ""
                    	_dataWriteMainApp["data"]["company"] = ""
                    	_dataWriteMainApp["data"]["ID"] = IDCardNumber
                    	Mqtt.MqttPathPublish = "MainApp"
